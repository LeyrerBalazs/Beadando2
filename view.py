...
class Window:
    ...
    def _Loggined(self):
        ...
        if self.u.farm.level == self.u.farm.maxlevel:
            tk.Label(loggined_frame, text="Max", bg=self.bg_color).place(x=50, y=buildings_y_label2)
        else:
        ...
        if self.u.goldmine.level == self.u.goldmine.maxlevel:
            tk.Label(loggined_frame, text="Max", bg=self.bg_color).place(x=150, y=buildings_y_label2)
        else:
